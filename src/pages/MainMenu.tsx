        ...
        <div className="space-y-4 mb-12">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="py-5 px-4 bg-amber-700 hover:bg-amber-600 text-amber-50 rounded-lg
                         transition-all duration-200 shadow-lg hover:shadow-amber-700/30
                         border border-amber-600/50 hover:border-amber-500/50
                         flex flex-col items-center justify-center gap-2 group"
            >
              <svg className="w-7 h-7 text-amber-200 group-hover:text-amber-100 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <span className="text-base font-semibold tracking-wider">通用快速建卡</span>
              <span className="text-[11px] text-amber-200/70">分步引导 · 手动配置</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-base font-semibold tracking-wider">玩家画像式建卡</span>
              <span className="text-[11px] text-amber-200/70">问卷匹配 · 智能推荐</span>
            </button>
          </div>
